...
internal interface ILMatcher
{
    ...
    {
        if (field == null)
            LobbyControl.Log.LogWarning($"Field passed to ILMatcher.Ldfld() was null\n{new StackTrace()}");
    ...
    {
        if (field == null)
            LobbyControl.Log.LogWarning($"Field passed to ILMatcher.Ldsfld() was null\n{new StackTrace()}");
    ...
    {
        if (field == null)
            LobbyControl.Log.LogWarning($"Field passed to ILMatcher.Stfld() was null\n{new StackTrace()}");
    ...
    {
        if (field == null)
            LobbyControl.Log.LogWarning($"Field passed to ILMatcher.Stsfld() was null\n{new StackTrace()}");
    ...
    {
        if (method == null)
            LobbyControl.Log.LogWarning($"Method passed to ILMatcher.Callvirt() was null\n{new StackTrace()}");
    ...
    {
        if (method == null)
            LobbyControl.Log.LogWarning($"Method passed to ILMatcher.Call() was null\n{new StackTrace()}");
